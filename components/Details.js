...
const Details = ({ data, setShowDetails }) => {
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 p-10">
      <div className="bg-gray-50 border rounded-lg p-4 max-w-lg w-full mx-auto mt-20 relative z-10">
        <div
        ...
        <div className="border-t-2 border-gray-200 py-2 pt-5 mt-4 flex space-x-2 justify-end">
          <button
